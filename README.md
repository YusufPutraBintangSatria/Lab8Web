...
if ($artikel) :
  foreach ($artikel as $row) : ?>
    <article class="entry">
      ...
      <ss src="<?= base_url('/gambar/' . $row['gambar']); ?>" alt="<?= $row['judul']; ?>">
...
<article class="entry">
  ...
  <h2><?= $artikel['judul']; ?></h2>
  <ss src="<?= base_url('/gambar/' . $artikel['gambar']); ?>" alt="<?= $artikel['judul']; ?>">
  <p>
    <?= $artikel['isi']; ?>
  </p>
</article>
